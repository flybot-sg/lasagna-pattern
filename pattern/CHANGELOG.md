...
- Runs on [ClojureCLR](https://github.com/clojure/clojure-clr); `bb clr-test pattern` runs both suites there. Malli and SCI stay JVM/JS only - [#34](https://github.com/flybot-sg/lasagna-pattern/issues/34).

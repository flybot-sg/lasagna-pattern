...
```clojure
{:data <matched-data>     ;; The matched/transformed data
 :vars <bindings-map>}    ;; Symbol → value bindings from ?variables
```
...
;; Result
{:data {:user {:name "Alice" :email "alice@ex.com"}}
 :vars {'name "Alice" 'email "alice@ex.com"}}
```
...
```clojure
;; Admin sees
{:data {:user {:id :number :name :string :email :string :role :keyword}
...
**Response:**
```clojure
{:data {:posts {:id 42 :title "Hello World" :author "Alice"}}
 :vars {'post {:id 42 :title "Hello World" :author "Alice"}}}
```
...
**Response:**
```clojure
{:data {:posts {:id 100 :title "New Post" :content "..." :created-at #inst "2025-01-25"}}
 :vars {'posts {:id 100 :title "New Post" :content "..." :created-at #inst "2025-01-25"}}}
```
...
**Response:**
```clojure
{:data {:posts {:id 42 :title "Updated Title" :content "..." :updated-at #inst "2025-01-25"}}
 :vars {'posts {:id 42 :title "Updated Title" :content "..." :updated-at #inst "2025-01-25"}}}
```

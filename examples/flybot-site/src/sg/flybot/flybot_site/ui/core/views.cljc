...
(defalias site-header
  "Site header with logo, navigation, GitHub link, theme toggle, and user auth."
  [{::keys [db dispatch!]}]
  (let [user (:user db)]
    [:header.site-header
     ...
     [:div.header-right
      ...
      [:a.icon-btn {:href "https://github.com/flybot-sg" :title "Flybot on GitHub" :target "_blank"}
       (github-icon)]
